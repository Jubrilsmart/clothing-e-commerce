...
import BannerImg from '../../assets/website/girlat.jpg'
        ...
        <div className='container'>
            ...
            {/* text details section */}
              <div className='flex flex-col justify-center gap-4 sm:pt-0'>
                ...
                <p className='text-[13px] sm:text-sm text-gray-500 tracking-wide leading-5'>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Totam sapiente nam ipsum unde soluta cum harum vero doloremque.
                </p>
                <div className='flex flex-col justify-center gap-4 text-sm sm:text-lg'>
                  <div data-aos='fade-up' className='flex items-center gap-2'>
                    <GrSecure className='text-4xl h-12 w-12 shadow-sm p-4 rounded-full bg-violet-100 dark:bg-violet-400'/>
                    <p>Quality Products</p>
                  </div>
                  <div data-aos='fade-up' className='flex items-center gap-2'>
                    <IoFastFood className='text-4xl h-12 w-12 shadow-sm p- rounded-full bg-orange-100 dark:bg-orange-400'/>
                    <p>Fast Delivery</p>
                  </div>
                  <div data-aos='fade-up' className='flex items-center gap-2'>
